        ...
        <div className='px-2'>
          ...
          <ul className='space-y-5 mt-3 px-3 [&_p]:text-sm [&_p]:md:text-lg'>
            <li className='flex gap-2 items-center justify-start'>
              <span className='rounded-full bg-blue-100 text-blue-400 size-10 aspect-square grid place-content-center font-bold text-xl w-max'>
                1
              </span>
            ...
            <li className='flex gap-2 items-center justify-start'>
              <span className='rounded-full bg-secondary text-red-400/90 size-10 aspect-square grid place-content-center font-bold text-xl w-max'>
                3
              </span>
              <p>Purchase a plan that fits your active student count and your future needs</p>
            </li>
            ...
            <li className='flex gap-2 items-center justify-start'>
              <span className='rounded-full bg-green-100 text-green-400 size-10 aspect-square grid place-content-center font-bold text-xl w-max'>
                4
              </span>
              <p>Purchase a plan that fits your active student count and your future needs</p>
            </li>
