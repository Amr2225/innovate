...
class TeacherCoursesMetricsView(generics.GenericAPIView):
    ...
    GET /api/teacher-analytics/courses-metrics/ - Returns metrics for all courses taught by the teacher
    ...
    def get(self, request):
        ...
        for course in courses:
            ...
            for enrollment in enrollments:
                ...
                if completed_lectures == total_course_lectures:
        ...
        overall_metrics = {
            ...
            "total_students": unique_students,  # Use the count of unique students
