...
class Enrollments(models.Model):
    ...
    def update_total_score(self):
        ...
        """
        print(
            f"DEBUG: Starting enrollment update_total_score for enrollment {self.id}")
        ...
        total = scores.aggregate(total=Sum('total_score'))[
        ...
        self.save()
        print(
            f"DEBUG: Saved enrollment with new total_score: {self.total_score}")
