...
urlpatterns = [
    ...
    path('promote-students-summer/', views.PromoteStudentsSummerAPIView.as_view(), name='promote-students-summer'),
    path('all-grades/', views.AllStudentGradesView.as_view(), name='all_student_grades')
]
