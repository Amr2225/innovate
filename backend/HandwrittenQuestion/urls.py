...
router.register(r'questions', HandwrittenQuestionViewSet, basename='handwritten-question')
router.register(r'scores', HandwrittenQuestionScoreViewSet, basename='handwritten-score')
