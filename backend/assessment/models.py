...
<<<<<<< HEAD
    ...
    institution = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='created_assessments', limit_choices_to={"role": "Teacher"})
    title = models.CharField(max_length=255)
    type = models.CharField(max_length=50, choices=[(
        'Exam', 'Exam'), ('Assignment', 'Assignment'), ('Quiz', 'Quiz')])
...
class AssessmentScore(models.Model):
    ...
    assessment = models.ForeignKey(
        Assessment, on_delete=models.CASCADE, related_name='assessment_scores')
    student = models.ForeignKey(User, on_delete=models.CASCADE,
                                related_name='assessment_scores', limit_choices_to={"role": "Student"})
